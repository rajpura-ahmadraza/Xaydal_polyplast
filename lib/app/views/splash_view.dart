...
class _SplashViewState extends State<SplashView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _rs1 = Tween<double>(begin: 0.4, end: 1.3)
        .animate(CurvedAnimation(parent: _ringCtrl, curve: Curves.easeOut));
    _ro1 = Tween<double>(begin: 0.7, end: 0.0)
        .animate(CurvedAnimation(parent: _ringCtrl, curve: Curves.easeOut));
    _rs2 = Tween<double>(begin: 0.3, end: 1.5).animate(CurvedAnimation(
        parent: _ringCtrl,
        curve: const Interval(0.2, 1.0, curve: Curves.easeOut)));
    _ro2 = Tween<double>(begin: 0.4, end: 0.0).animate(CurvedAnimation(
        parent: _ringCtrl,
        curve: const Interval(0.2, 1.0, curve: Curves.easeOut)));
    _logoS = Tween<double>(begin: 0.0, end: 1.0)
        .animate(CurvedAnimation(parent: _logoCtrl, curve: Curves.elasticOut));
    _logoR = Tween<double>(begin: -0.25, end: 0.0)
    ...
    _bar = Tween<double>(begin: 0.0, end: 1.0)
        ...
        child: Stack(children: [
                    ...
                    children: [
                      AnimatedBuilder(
                          ...
                          builder: (_, __) => Transform.scale(
                              scale: _rs2.value,
                              child: Opacity(
                                  opacity: _ro2.value.clamp(0.0, 1.0),
                                  child: Container(
                                      width: 180,
                                      height: 180,
                                      decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                              color: C.g500, width: 1.0)))))),
                      AnimatedBuilder(
                          animation: _ringCtrl,
                          builder: (_, __) => Transform.scale(
                              scale: _rs1.value,
                              child: Opacity(
                                  opacity: _ro1.value.clamp(0.0, 1.0),
                                  child: Container(
                                      width: 160,
                                      height: 160,
                                      decoration: BoxDecoration(
                    ...
                    builder: (_, __) => Opacity(
                        ...
                        child: Transform.translate(
                            ...
                            child: Column(children: [
                              ...
                              Text('Your trusted plastic supplier',
                                  style: GoogleFonts.poppins(
                          ...
                          Padding(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: LinearProgressIndicator(
                                      value: _bar.value,
                                      minHeight: 3,
                                      backgroundColor: C.s700,
                                      valueColor: const AlwaysStoppedAnimation(
                                          C.g500)))),
                          const SizedBox(height: 12),
                          Text('Loading Xaydal Application...',
                              style: GoogleFonts.poppins(
          ...
          Positioned(
              ...
              child: AnimatedBuilder(
                  ...
                  builder: (_, __) => Opacity(
                      opacity: _fade.value,
                      child: Text('Powered by Xaydal Group',
                          textAlign: TextAlign.center,
                          style: GoogleFonts.poppins(
                              fontSize: 11, color: C.s600))))),
        ]),
      ),
    );
  }
  ...
  Widget _dot(double size) => Container(
      width: size,
      height: size,
      decoration: const BoxDecoration(shape: BoxShape.circle, color: C.g500));
}
