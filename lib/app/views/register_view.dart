...
class RegisterView extends GetView<AuthController> {
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: dark ? [] : [BoxShadow(color: C.g700.withOpacity(0.1), blurRadius: 20, offset: const Offset(0, 4))],
                ),
                child: Form(
                  key: formKey,
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('Business Setup', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.w700)),
                    Text('Create your premium business account', style: GoogleFonts.poppins(fontSize: 13, color: C.s500)),
                    const SizedBox(height: 22),

                    _field(nameCtrl, 'Full Name', Icons.person_outline, dark,
                        validator: (v) => (v?.trim().isEmpty ?? true) ? 'Please enter your name' : null),
                    const SizedBox(height: 12),
                    _field(bizCtrl, 'Business Name', Icons.business_outlined, dark,
                        validator: (v) => (v?.trim().isEmpty ?? true) ? 'Please enter business name' : null),
                    const SizedBox(height: 12),
                    _field(emailCtrl, 'Email Address', Icons.email_outlined, dark,
                      ...
                      child: ElevatedButton(
                        onPressed: controller.isLoading.value ? null : () {
                          if (formKey.currentState!.validate()) {
                            controller.register(nameCtrl.text, emailCtrl.text, passCtrl.text, bizCtrl.text);
                          }
                        },
                    ...
                    Center(child: GestureDetector(
                      ...
                      child: RichText(text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(text: 'Sign In', style: GoogleFonts.poppins(color: dark ? C.g400 : C.g700, fontWeight: FontWeight.w600)),
                        ],
                      )),
                    )),
                  ]),
  ...
  Widget _field(TextEditingController c, String label, IconData icon, bool dark,
      ...
      TextFormField(
        controller: c, keyboardType: type, validator: validator,
        decoration: InputDecoration(labelText: label,
            prefixIcon: Icon(icon, size: 20), prefixIconColor: dark ? C.g400 : C.g700),
      );
}
