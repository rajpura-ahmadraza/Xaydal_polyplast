...
// ═══════════════════════════════════════════════════════════════
// ADD ORDER VIEW (CUSTOMER DROPDOWN ADDED - DESIGN SAME)
// ═══════════════════════════════════════════════════════════════
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:google_fonts/google_fonts.dart';
            ...
            _section(
              ...
              Obx(() {
                return DropdownButtonFormField<String>(
                  ...
                  onChanged: (id) {
                    selCustomerId.value = id;

                    final customer =
                        controller.customers.firstWhere((e) => e.id == id);
